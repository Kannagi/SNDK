...
int main(int argc, char** argv)
{
	...
	if(option[9] != 0)
	{
		...
		if(option[9] == 1)
		{
			...
			BLOC_CONVERT(0,128,128,64);
			BLOC_CONVERT(0,192,128,64);
			SDL_FreeSurface(copymap);

			copymap = SDL_CreateRGBSurface(0,128,128,24,0,0,0,0);
			BLOC_CONVERT(128,0,128,128);
			SDL_FreeSurface(copymap);

			copymap = SDL_CreateRGBSurface(0,128,112,24,0,0,0,0);
			BLOC_CONVERT(128,128,128,112);
			SDL_FreeSurface(copymap);

			copymap = SDL_CreateRGBSurface(0,128,16,24,0,0,0,0);
			BLOC_CONVERT(128,240,128,16);
			SDL_FreeSurface(copymap);
