...
Super_Kannagi_Sound();
SNDK_ROM_LOAD()"SPC/Super_Kannagi_Sound.spc";
...
void SNDK_VBlank()
{
	...
	uint16 tileset.vaddr,tileset.addr,tileset.size,tileset.bank,tileset.channel;
...
void SNDK_SetVBlank_adrbg3( uint16 val)
{
...
void SNDK_SetVBlank_bg3size( uint16 val)
{
