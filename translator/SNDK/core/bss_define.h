...
uint8 SNDK_BufferSPR4 0x2000;

uint8 SNDK_BufferSPR5 0x2000;
uint8 SNDK_BufferSPR6 0x2000;
uint8 SNDK_BufferSPR7 0x2000;
...
uint8 SNDK_SFX_TIMER;
uint16 SNDK_vrand,SNDK.count_pal;
uint8 SNDK_Light,SNDK_TM,SNDK_AlphaMode,SNDK_BGNBA,SNDK_TIMER,SNDK_BGMODE;

uint16 SNDK_ZBUFFER 0x18;
uint16 SNDK_ZBUFFER_OUT 0x18;
...
uint16 SNDK_BG_Scroll.addy;
uint16 SNDK_BG_Scroll.addx;
...
uint16 SNDK_SPRITE.mode;
uint16 SNDK_SPRITE.ianim;
uint16 SNDK_SPRITE.offsetx;
uint16 SNDK_SPRITE.offsety;

uint16 SNDK_SPRITE.oam;
uint8 SNDK_SPRITE.flag;
uint8 SNDK_SPRITE.eanim;

uint8 SNDK_SPRITE.draw;
uint8 SNDK_SPRITE.bank;
uint8 SNDK_SPRITE.add;

uint8 SNDK_SPRITE (0x400);



uint8 SNDK_ZORDER 0x80;

uint8 SNDK_BUF_BG1.v 0x40;
uint8 SNDK_BUF_BG2.v 0x40;

uint16 SNDK_BUF_BG1.h1;
uint16 SNDK_BUF_BG1.h2;

uint16 SNDK_BUF_BG2.h1;
uint16 SNDK_BUF_BG2.h2;
...
uint8 SNDK_Bullet.t;
uint8 SNDK_Bullet.a 0x100;
uint16 SNDK_Bullet.id 0x80;

uint16 SNDK_Bullet.usable1  0x80;
uint16 SNDK_Bullet.usable2  0x80;
...
uint8 SNDK_BufferBGC 0x2000;
uint8 SNDK_BufferSPR1 0x3000;
uint8 SNDK_BufferSPR2 0x3000;
...
.define SNDK_BG_SCROLL_UP 0x00;
.define SNDK_BG_SCROLL_DOWN 0x1C0;
.define SNDK_BG_SCROLL_LEFT 0x00;
.define SNDK_BG_SCROLL_RIGHT 0x10;


void SNDK_SpriteEngineSetList (){
	idx= .arg1;
...
.define SNDK_BG1 0x01;
.define SNDK_BG2 0x02;
.define SNDK_BG3 0x04;
.define SNDK_BG4 0x08;
.define SNDK_OBJ 0x10;

.define OAM_YFLIP 0x80;
.define OAM_XFLIP 0x40;
...
.define SNDK_PAD_START 0x10;
.define SNDK_PAD_SELECT 0x20;
...
.define SAVEY   asm "phy";
.define RESTOREY asm "ply";
...
.define SPR_INDEX_S0 0x200;
.define SPR_INDEX_S1 0x220;
.define SPR_INDEX_S2 0x240;
.define SPR_INDEX_S3 0x260;

.define SPR_INDEX_S4 0x280;
.define SPR_INDEX_S5 0x2A0;
.define SPR_INDEX_S6 0x2C0;
.define SPR_INDEX_S7 0x2E0;

.define SPR_INDEX_S8 0x300;
.define SPR_INDEX_S9 0x320;
.define SPR_INDEX_S10 0x340;
.define SPR_INDEX_S11 0x360;

.define SPR_INDEX_S12 0x380;
.define SPR_INDEX_S13 0x3A0;
.define SPR_INDEX_S14 0x3C0;
.define SPR_INDEX_S15 0x3E0;


.define SNDK_SPC_VOLUME	0x10;
.define SNDK_SPC_PLAY  	0x12;
.define SNDK_SPC_ADDR	0x14;
.define SNDK_SPC_DATA	0x16;

.define SNDK_SPC_RDATA	0x18;
.define SNDK_SPC_TICKS	0x1A;
.define SNDK_SPC_DEBUG	0x1C;
.define SNDK_SPC_RADDR	0x1E;

.define SNDK_SPC_BRR_VOLUME	0x20;
.define SNDK_SPC_BRR_PLAY		0x22;
.define SNDK_SPC_BRR_PLAY_TEST 	0x24;
.define SNDK_SPC_BRR_PLAY76	0x26;
.define SNDK_SPC_BRR_PLAY54	0x28;
.define SNDK_SPC_SVOLUME	0x30;

.define SNDK_SPC_STOP 	0xFF;
.define SNDK_SPC_ON 	0x01;
.define SNDK_SPC_REPLAY	0x02;
.define SNDK_SPC_PAUSE 0x00;
